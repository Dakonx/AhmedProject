...
<body
	...
	<div align="center">
		<form method="POST" action="choisirquizz">
			<%
				List<Quizz> quizzs = QuizzBDD.getQuizzBySujet((String) request.getSession().getAttribute("sujet"));// r�cup�rer tous les quizz qui ont pour sujet le sujet s�lectionn�
				String loginUser = String.valueOf(request.getSession().getAttribute("login"));
				User user = UserBDD.getUserByLogin(loginUser);
				List<Parcour> parcours = ParcoursBDD.getParcoursByIDUser(user.getId());// r�cuperer tous les parcours d�j� r�alis� par ce user
